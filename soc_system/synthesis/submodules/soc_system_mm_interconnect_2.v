...
module soc_system_mm_interconnect_2 (
	...
	wire  [114:0] dipsw_pio_s1_agent_rf_source_data;                               // dipsw_pio_s1_agent:rf_source_data -> dipsw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] dipsw_pio_s1_agent_rsp_fifo_out_data;                            // dipsw_pio_s1_agent_rsp_fifo:out_data -> dipsw_pio_s1_agent:rf_sink_data
	...
	wire  [114:0] button_pio_s1_agent_rf_source_data;                              // button_pio_s1_agent:rf_source_data -> button_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] button_pio_s1_agent_rsp_fifo_out_data;                           // button_pio_s1_agent_rsp_fifo:out_data -> button_pio_s1_agent:rf_sink_data
	...
	wire  [113:0] dipsw_pio_s1_agent_rp_data;                                      // dipsw_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [113:0] button_pio_s1_agent_rp_data;                                     // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [113:0] cmd_mux_001_src_data;                                            // cmd_mux_001:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	...
	wire  [113:0] sysid_qsys_control_slave_burst_adapter_source0_data;             // sysid_qsys_control_slave_burst_adapter:source0_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [113:0] cmd_mux_002_src_data;                                            // cmd_mux_002:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                           // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                         // cmd_mux_002:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] dipsw_pio_s1_burst_adapter_source0_data;                         // dipsw_pio_s1_burst_adapter:source0_data -> dipsw_pio_s1_agent:cp_data
	wire          dipsw_pio_s1_burst_adapter_source0_ready;                        // dipsw_pio_s1_agent:cp_ready -> dipsw_pio_s1_burst_adapter:source0_ready
	wire    [3:0] dipsw_pio_s1_burst_adapter_source0_channel;                      // dipsw_pio_s1_burst_adapter:source0_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire  [113:0] cmd_mux_003_src_data;                                            // cmd_mux_003:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                           // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                         // cmd_mux_003:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] button_pio_s1_burst_adapter_source0_data;                        // button_pio_s1_burst_adapter:source0_data -> button_pio_s1_agent:cp_data
	wire          button_pio_s1_burst_adapter_source0_ready;                       // button_pio_s1_agent:cp_ready -> button_pio_s1_burst_adapter:source0_ready
	wire    [3:0] button_pio_s1_burst_adapter_source0_channel;                     // button_pio_s1_burst_adapter:source0_channel -> button_pio_s1_agent:cp_channel
